...
(function(window) {
    ...
    const SM_UI = {
        showNotification: function(message, isError = false) {
            let container = document.querySelector('.sm-notification-container');
            if (!container) {
                container = document.createElement('div');
                container.className = 'sm-notification-container';
                document.body.appendChild(container);
            }
            const notif = document.createElement('div');
            notif.className = 'sm-notification ' + (isError ? 'error' : 'success');
            notif.innerHTML = `
                <span class="dashicons dashicons-${isError ? 'warning' : 'yes-alt'}"></span>
                <span>${message}</span>
            `;
...
<div class="sm-admin-dashboard" dir="rtl" style="font-family: 'Rubik', sans-serif; background: <?php echo $appearance['bg_color']; ?>; border: none; border-radius: 0; overflow: hidden; color: <?php echo $appearance['font_color']; ?>; font-size: <?php echo $appearance['font_size']; ?>; font-weight: <?php echo $appearance['font_weight']; ?>; line-height: <?php echo $appearance['line_spacing']; ?>;">
    ...
    <div class="sm-main-header">
        ...
        <div style="display: flex; align-items: center; gap: 20px;">
            ...
            <!-- Unified Interface via [login-page] Shortcode -->
            <div class="sm-unified-topbar-wrap">
                <?php echo do_shortcode('[login-page]'); ?>
            </div>
        </div>
    </div>
    <?php endif; ?>
            ...
            <ul style="list-style: none; padding: 0; margin: 0;">
                ...
                <?php if (SM_Settings::can_role_access($user_role, 'finance')): ?>
                    <li class="sm-sidebar-item <?php echo $active_tab == 'finance' ? 'sm-active' : ''; ?>">
                        <a href="<?php echo add_query_arg('sm_tab', 'finance'); ?>" class="sm-sidebar-link"><span class="dashicons dashicons-money-alt"></span> <?php echo $labels['tab_finance']; ?></a>
                    </li>
                <?php endif; ?>
                ...
                <?php if (SM_Settings::can_role_access($user_role, 'licenses')): ?>
                    <li class="sm-sidebar-item <?php echo $active_tab == 'practice-licenses' ? 'sm-active' : ''; ?>">
                        <a href="<?php echo add_query_arg('sm_tab', 'practice-licenses'); ?>" class="sm-sidebar-link"><span class="dashicons dashicons-id-alt"></span> <?php echo $labels['tab_practice_licenses']; ?></a>
                    </li>
                    <li class="sm-sidebar-item <?php echo $active_tab == 'facility-licenses' ? 'sm-active' : ''; ?>">
                        <a href="<?php echo add_query_arg('sm_tab', 'facility-licenses'); ?>" class="sm-sidebar-link"><span class="dashicons dashicons-building"></span> <?php echo $labels['tab_facility_licenses']; ?></a>
                    </li>
                <?php endif; ?>
                ...
                <?php if (SM_Settings::can_role_access($user_role, 'services')): ?>
                    <li class="sm-sidebar-item <?php echo $active_tab == 'digital-services' ? 'sm-active' : ''; ?>">
                        <a href="<?php echo add_query_arg('sm_tab', 'digital-services'); ?>" class="sm-sidebar-link"><span class="dashicons dashicons-cloud"></span> <?php echo $labels['tab_digital_services']; ?></a>
                    </li>
                <?php endif; ?>
                ...
                <?php if (SM_Settings::can_role_access($user_role, 'education')): ?>
                    <li class="sm-sidebar-item <?php echo in_array($active_tab, ['surveys', 'test-questions']) ? 'sm-active' : ''; ?>">
                        ...
                        <ul class="sm-sidebar-dropdown" style="display: <?php echo in_array($active_tab, ['surveys', 'test-questions']) ? 'block' : 'none'; ?>;">
                            <?php if($is_admin || $is_general_officer || $is_branch_officer): ?>
                                <li><a href="<?php echo add_query_arg('sm_tab', 'surveys'); ?>" class="<?php echo $active_tab == 'surveys' ? 'sm-sub-active' : ''; ?>"><span class="dashicons dashicons-chart-bar"></span> امتحانات التصاريح</a></li>
                            <?php endif; ?>
                ...
                <?php if($is_admin || $is_general_officer || $is_branch_officer): ?>
                    <li class="sm-sidebar-item <?php echo $active_tab == 'certificates' ? 'sm-active' : ''; ?>">
                        <a href="<?php echo add_query_arg('sm_tab', 'certificates'); ?>" class="sm-sidebar-link"><span class="dashicons dashicons-awards"></span> إدارة الشهادات</a>
                    </li>
                <?php endif; ?>
                ...
                <?php if (SM_Settings::can_role_access($user_role, 'archive')): ?>
                    <li class="sm-sidebar-item <?php echo $active_tab == 'global-archive' ? 'sm-active' : ''; ?>">
                        <a href="<?php echo add_query_arg(['sm_tab' => 'global-archive']); ?>" class="sm-sidebar-link"><span class="dashicons dashicons-portfolio"></span> <?php echo $labels['tab_global_archive']; ?></a>
                    </li>
                <?php endif; ?>

                <?php if ($is_admin || $is_general_officer || $is_branch_officer): ?>
                    <li class="sm-sidebar-item <?php echo $active_tab == 'branches' ? 'sm-active' : ''; ?>">
                        <a href="<?php echo add_query_arg(['sm_tab' => 'branches']); ?>" class="sm-sidebar-link"><span class="dashicons dashicons-networking"></span> <?php echo $labels['tab_branches']; ?></a>
                    </li>
...
@media (max-width: 768px) {
    .sm-main-header { flex-wrap: wrap; gap: 15px; }
    .sm-header-info-box { display: none !important; }
    .sm-main-header .sm-btn { display: none !important; }
    .sm-admin-layout { flex-direction: column !important; }
    .sm-sidebar { width: 100% !important; border-left: none !important; border-bottom: 1px solid var(--sm-border-color); }
    .sm-main-panel { padding: 15px !important; }
}
</style>
