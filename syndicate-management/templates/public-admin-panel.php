            ...
            <ul style="list-style: none; padding: 0; margin: 0;">
                ...
                <?php if (SM_Settings::can_role_access($user_role, 'licenses')): ?>
                    <li class="sm-sidebar-item <?php echo $active_tab == 'practice-licenses' ? 'sm-active' : ''; ?>">
                        <a href="<?php echo add_query_arg('sm_tab', 'practice-licenses'); ?>" class="sm-sidebar-link"><span class="dashicons dashicons-id-alt"></span> قسم تصاريح مزاولة المهنة</a>
                    </li>
                ...
                <?php if (SM_Settings::can_role_access($user_role, 'education')): ?>
                    <li class="sm-sidebar-item <?php echo in_array($active_tab, ['surveys', 'test-questions']) ? 'sm-active' : ''; ?>">
                        <a href="<?php echo add_query_arg('sm_tab', 'surveys'); ?>" class="sm-sidebar-link"><span class="dashicons dashicons-welcome-learn-more"></span> إدارة الاختبارات</a>
