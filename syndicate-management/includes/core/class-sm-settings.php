...
class SM_Settings {
    ...
    public static function get_labels() {
        $default = array(
            ...
            'tab_practice_licenses' => 'قسم تصاريح مزاولة المهنة',
            'tab_facility_licenses' => 'تسجيل وتراخيص المنشآت',
            'tab_staffs' => 'إدارة مستخدمي النظام',
            'tab_surveys' => 'إدارة الاختبارات المهنية',
            ...
            'tab_digital_services' => 'بوابة الخدمات الرقمية',
            'tab_global_archive' => 'مركز الأرشيف الرقمي',
            'field_specialty' => 'التخصص المهني الدقيق',
            'field_grade' => 'الدرجة المهنية',
    ...
    public static function get_policies() {
        $default = array(
            'privacy' => array(
                ...
                'category' => 'general',
                'content' => "تعتبر خصوصية بيانات أعضاء نقابة الإصابات والتأهيل من أولوياتنا القصوى. نحن نلتزم بالآتي:\n1. جمع البيانات الضرورية فقط لتقديم الخدمات النقابية والمهنية.\n2. استخدام تقنيات تشفير متقدمة لحماية قواعد البيانات من الوصول غير المصرح به.\n3. عدم بيع أو مشاركة بيانات الأعضاء مع أي جهات تسويقية خارجية.\n4. يحق للعضو الاطلاع على بياناته وتحديثها عبر المنصة الرقمية في أي وقت."
            ),
            'terms' => array(
                'title' => 'الشروط والأحكام العامة للمنصة',
                'category' => 'general',
                'content' => "باستخدامك للمنصة الرقمية لنقابة الإصابات والتأهيل، فإنك تقر بالآتي:\n- الالتزام بكافة اللوائح والقوانين المنظمة للعمل النقابي في جمهورية مصر العربية.\n- مسؤوليتك الكاملة عن سرية بيانات الدخول الخاصة بحسابك.\n- استخدام المنصة للأغراض المهنية والخدمية المخصصة لها فقط.\n- للنقابة الحق في تعليق الحساب في حال ثبوت استخدام مخالف للقانون أو ميثاق الشرف المهني."
            ),
            'membership' => array(
                'title' => 'سياسة القيد والعضوية النقابية',
                'category' => 'membership',
                'content' => "تنظم هذه السياسة حقوق وواجبات الأعضاء:\n- يتم قبول العضوية بناءً على المؤهلات العلمية المعتمدة من المجلس الأعلى للجامعات.\n- يجب سداد الاشتراكات السنوية في المواعيد المقررة قانوناً لتجنب الغرامات أو تجميد العضوية.\n- يستفيد العضو العامل من كافة المزايا العلاجية، والاجتماعية، والمهنية التي توفرها النقابة.\n- فقدان العضوية يتم وفقاً للحالات المنصوص عليها في قانون إنشاء النقابة."
            ),
            'data_usage' => array(
                'title' => 'سياسة الاستخدام الرقمي والتقني',
                'category' => 'technical',
                'content' => "توضح هذه السياسة كيفية التعامل مع المحتوى الرقمي:\n- كافة الشهادات والتراخيص المستخرجة إلكترونياً تحمل أكواد تحقق رقمية تضمن صحتها.\n- يمنع منعاً باتاً محاولة التلاعب بالبيانات أو إجراء هجمات سيبرانية على خوادم النقابة.\n- يتم تسجيل كافة العمليات المنفذة على النظام لضمان الشفافية والرقابة الإدارية.\n- الروابط الخارجية الموجودة بالمنصة تخضع لسياسات المواقع الخاصة بها."
            ),
            'conduct' => array(
                'title' => 'ميثاق السلوك المهني والأخلاقي',
                'category' => 'professional',
                'content' => "يتعهد الممارس العام في مجال الإصابات الرياضية والتأهيل بالآتي:\n- الحفاظ على أسرار المرضى واللاعبين الذين يقوم بالإشراف على تأهيلهم.\n- ممارسة المهنة في حدود التخصص والدرجة العلمية والوظيفية المرخص بها.\n- عدم الترويج لمنتجات أو ممارسات طبية غير معتمدة علمياً.\n- التعاون مع الزملاء والجهات الطبية المختصة لضمان أفضل رعاية للمصابين."
            )
        );
        return get_option('sm_policies', $default);
    }

    public static function get_policy_categories() {
        return array(
            'general' => 'سياسات عامة',
            'membership' => 'القيد والعضوية',
            'professional' => 'السلوك المهني',
            'technical' => 'الاستخدام التقني',
            'legal' => 'الشؤون القانونية'
        );
    }

    public static function save_policies($data) {
        update_option('sm_policies', $data);
    }
}
